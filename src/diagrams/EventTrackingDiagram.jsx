...
const INITIAL_NODES = [
  ...
  { id: 'event-proxy', type: 'service', position: { x: 240, y: 90 }, data: { label: 'Your API Gateway', subtitle: 'Option B — key injected server-side', borderColor: '#fb923c' } },
  ...
  { id: 'events-api', type: 'external', position: { x: 530, y: 50 }, data: { label: 'Topsort Events API', subtitle: 'POST /v2/events', borderColor: '#a78bfa' } },
]
