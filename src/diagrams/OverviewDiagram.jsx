...
const ZONE_NODES = [
  { id: 'zone-mkt', type: 'zone', position: { x: -15, y: -15 }, data: { label: 'Your Marketplace', color: '#34d399' }, style: { width: 370, height: 460 }, draggable: false, selectable: false, zIndex: -1 },
...
const INITIAL_NODES = [
  ...
  { id: 'ts-client', type: 'service', position: { x: 175, y: 175 }, data: { label: 'Topsort Client', subtitle: 'Circuit Breaker', borderColor: '#34d399' } },
  { id: 'catalog-svc', type: 'service', position: { x: 10, y: 255 }, data: { label: 'Catalog Service', badge: 'EXISTING', borderColor: '#34d399' } },
  { id: 'event-relay', type: 'service', position: { x: 175, y: 255 }, data: { label: 'Event Relay', subtitle: 'Batch + Retry', borderColor: '#34d399' } },
